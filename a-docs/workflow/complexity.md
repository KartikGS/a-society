...
- **Curator required:** when the flow touches Curator-owned stewardship surfaces such as indexes, ownership files, feedback registries, or conversation-template surfaces
