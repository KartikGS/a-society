...
**Status:** Framework active at v4.0. thinking/ folder now required initialization artifact (Breaking, v4.0). Classification pre-specification prohibition added to Owner role and briefing template.
