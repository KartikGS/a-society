...
**Closure artifacts use descriptive names.** Name the closure artifact for the closed flow or closure purpose, and cite its exact repo-relative path when the flow is closed.
